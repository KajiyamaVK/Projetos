						...
						<div className="row">
							<div className="col-lg-12">
								<div className="rn-page-title text-center pt--100">
									<h2 className="title theme-gradient">Logos</h2>
									<p>
										Criação de logos para serem utilizados de diversas formas
									</p>
								</div>
							</div>
						</div>
										...
										<div className="row sercice-details-content pb--80 align-items-center">
											...
											<div className="col-lg-6 col-12">
												<div className="details mt_md--30 mt_sm--30">
													<p>
														Existe uma grande importância em cima de seu logo.
														Esse é seu emblema de identidade.
													</p>
													<p>
